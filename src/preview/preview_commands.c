...
static const ShaulaPreviewCommandSpec command_specs[] = {
    ...
    {SHAULA_PREVIEW_COMMAND_SET_TOOL_TEXT, TRUE, SHAULA_TOOL_TEXT, GDK_KEY_4,
     0, "4"},
    ...
    {SHAULA_PREVIEW_COMMAND_SET_TOOL_CROP, TRUE, SHAULA_TOOL_CROP, GDK_KEY_9,
     0, "9"},
    {SHAULA_PREVIEW_COMMAND_SET_TOOL_CROP, TRUE, SHAULA_TOOL_CROP,
     GDK_KEY_KP_9, 0, "9"},
