...
pub fn main(init: std.process.Init) !u8 {
    ...
    if (argv.len < 2) {
        try daemon_json.writeErrorJson(io, "", "ERR_CLI_USAGE", "usage: shaula <capture|preview|notify|config|daemon|preflight|capabilities|history|clipboard|errors> ... --json", false);
